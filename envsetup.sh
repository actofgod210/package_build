...
function setpaths()
{
    ...
    case $ARCH in
        x86) toolchaindir=x86/i686-linux-android-$targetgccversion/bin
            ;;
        arm) toolchaindir=arm/arm-cortex_a15-linux-gnueabihf-linaro_4.9.1-2014.05-$targetgccversion/bin
            ;;
    ...
    case $ARCH in
        arm)
            toolchaindir=arm/arm-cortex_a15-linux-gnueabihf-linaro_4.9.1-2014.05-$targetgccversion/bin
            if [ -d "$gccprebuiltdir/$toolchaindir" ]; then
